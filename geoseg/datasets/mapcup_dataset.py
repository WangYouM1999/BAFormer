...
def get_training_transform():
    train_transform = [
        # albu.HueSaturationValue(always_apply=False, p=1.0, hue_shift_limit=(-20, 20), sat_shift_limit=(-30, 30),
...
class MapcupDataset(Dataset):
    def __init__(self, data_root='data/mapcup/test', mode='val', img_dir='images', mask_dir='masks',
...
class MapcupPredictDataset(Dataset):
    def __init__(self, data_root='data/mapcup/predict', mode='predict', img_dir='images', mask_dir=None,
