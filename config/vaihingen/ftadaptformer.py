...
from geoseg.models.FTAdaptFormer import ft_adaptformer
...
#  define the network
net = ft_adaptformer(num_classes=num_classes, decoder_channels=256)

# define the loss
loss = FTAdaptFormerLoss(ignore_index=ignore_index)
